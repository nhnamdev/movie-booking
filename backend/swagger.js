const fieldSchemas = {
  ...
  comment: { type: "string", example: "Phim rất hay và đáng xem!" },
...
const endpoints = [
  ...
  ["get", "/movieReviews/{movieId}", "Catalog", "Lấy điểm trung bình, phân bổ số sao và danh sách đánh giá của phim", ["movieId"]],
  ["post", "/movieReview", "Customer", "Thêm hoặc cập nhật đánh giá số sao và bình luận của người dùng cho phim", ["movieId", "rating", "comment"], ["comment"]],
  ["delete", "/movieReview/{reviewId}", "Customer", "Xóa đánh giá của người dùng hoặc Admin xóa", ["reviewId"]],
