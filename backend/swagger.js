const fieldSchemas = {
  ...
  staffPassword: { type: "string", format: "password", minLength: 6 },
  accountStatus: { type: "string", enum: ["active", "inactive"], example: "active" },
  customerPassword: { type: "string", format: "password", description: "Bắt buộc khi sử dụng điểm thưởng" },
...
const endpoints = [
  ...
  ["post", "/movieCombos", "Booking", "Lấy combo thường hoặc combo khuyến mãi theo phim", ["movieId"]],
  ["get", "/concessions/catalog", "Concessions", "Lấy danh mục bắp nước và danh sách chi nhánh"],
  ["post", "/concessions/payos/create-payment-link", "Concessions", "Tạo thanh toán PayOS cho đơn bắp nước trong 10 phút", ["email", "theatreId", "items", "customerPassword", "rewardPoints"], ["customerPassword", "rewardPoints"]],
  ["post", "/concessions/counter-orders/create", "Concessions", "Tạo đơn bắp nước nhận tại quầy trong 30 phút", ["email", "theatreId", "items", "customerPassword", "rewardPoints"], ["customerPassword", "rewardPoints"]],
  ...
  ["post", "/payos/create-payment-link", "Payment", "Tạo liên kết PayOS có hạn thanh toán 10 phút", paymentSelection, ["comboItems", "customerPassword", "rewardPoints"]],
  ["post", "/counter-orders/create", "Payment", "Giữ ghế và điểm 30 phút để thanh toán tại rạp", paymentSelection, ["comboItems", "customerPassword", "rewardPoints"]],
  ...
  ["post", "/customerRewards", "Rewards", "Lấy số dư, cấu hình và lịch sử điểm thưởng", ["email", "password"]],
  ["post", "/rewardQuote", "Rewards", "Báo giá số điểm tối đa và tiền được giảm", ["email", "password", "grossAmount", "requestedPoints"], ["requestedPoints"]],
  ...
  ["post", "/adminHallUpsert", "Admin - Cinemas", "Thêm hoặc sửa phòng chiếu", [...adminCredentials, "hallId", "theatreId", "name", "cinemaStatus"], ["hallId", "cinemaStatus"]],
  ...
  ["post", "/adminMovieUpdate", "Admin - Movies", "Cập nhật phim", [...adminCredentials, "movieId", "name", "image_path", "language", "synopsis", "rating", "duration", "top_cast", "release_date", "end_date", "genres", "directors"]],
  ["post", "/adminMovieDelete", "Admin - Movies", "Xoá phim chưa có vé", [...adminCredentials, "movieId"]],
  ["post", "/adminMovieAdd", "Admin - Movies", "Thêm phim", [...adminCredentials, "name", "image_path", "language", "synopsis", "rating", "duration", "top_cast", "release_date", "end_date"]],
